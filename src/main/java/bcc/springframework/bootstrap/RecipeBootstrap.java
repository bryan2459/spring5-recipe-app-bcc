package bcc.springframework.bootstrap;

import bcc.springframework.domain.*;
import bcc.springframework.repositories.CategoryRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        ...
        System.out.println("Bootstrap" + getRecipes());
    }
